...
class CountCog(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith("|"):
            ...
            await message.remove_reaction("<:ContactingWolframAlpha:951959127150690364>",self.bot.user)
...
https://wolframalpha.com/"""
    ...
    async def cchannel(self, ctx, operator, value=0):
        ...
        if operator == "list":
            ...
            channels+=""
            if channels == "":
                channels="I'm not linked to any channels in this server!\nAdd channels by running the command `!cchannel add` in them!"
